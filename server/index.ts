...
import { handleSendCompletionEmail } from "./routes/email";
import {
  handleUploadJobPhoto,
  handleGetJobPhotos,
  handleDeleteJobPhoto,
  handleUpdatePhotoLabel,
...
export async function createServer() {
  ...
  // Photo upload routes
  app.post("/api/jobs/:jobId/photos", photoUploadMiddleware, handleUploadJobPhoto);
  app.get("/api/jobs/:jobId/photos", handleGetJobPhotos);
  app.delete("/api/photos/:photoId", handleDeleteJobPhoto);
  app.put("/api/photos/:photoId/label", handleUpdatePhotoLabel);
  ...
  // Store a reference to setup socket.io later
  app.set('setupSocket', (httpServer: any) => {
